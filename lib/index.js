...
exports.clipboard = exports.shell = exports.fs = void 0;
...
var fs = /** @class */ (function () {
    ...
    var _a;
    _a = fs;
    fs.mv = function (sourceFile, destFile, callback, id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    fs.mvAll = function (sourceFiles, destDir, callback, id) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!callback) return [3 /*break*/, 2];
                    return [4 /*yield*/, MoveFile.mv_all(sourceFiles, destDir, callback, id)];
                case 1: return [2 /*return*/, _b.sent()];
                case 2: return [4 /*yield*/, MoveFile.mv_all(sourceFiles, destDir)];
                case 3: return [2 /*return*/, _b.sent()];
            }
        });
    }); };
    fs.mvSync = function (sourceFile, destFile) {
        return MoveFile.mv_sync(sourceFile, destFile);
    };
    fs.cancel = function (id) {
        return MoveFile.cancel(id);
    };
    fs.reserveCancellable = function () {
    ...
    fs.readdir = function (directory, recursive) {
        return MoveFile.readdir(directory, recursive);
    };
    fs.getContentType = function (filePath) {
...
var shell = /** @class */ (function () {
    ...
    shell.openPath = function (windowHandle, filePath) {
        return MoveFile.open_path(windowHandle, filePath);
    };
    shell.openPathWith = function (windowHandle, filePath) {
        return MoveFile.open_path_with(windowHandle, filePath);
    };
    shell.openFileProperty = function (windowHandle, filePath) {
