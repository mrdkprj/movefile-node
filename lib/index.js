...
exports.clipboard = exports.fs = void 0;
...
var fs = /** @class */ (function () {
    ...
    fs.mvBulk = function (sourceFiles, destDir, callback, id) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!callback) return [3 /*break*/, 2];
    ...
    fs.openPath = function (windowHandle, filePath) {
        return MoveFile.open_path(windowHandle, filePath);
    };
    fs.openPathWith = function (windowHandle, filePath) {
        return MoveFile.open_path_with(windowHandle, filePath);
    };
    fs.openFileProperty = function (windowHandle, filePath) {
