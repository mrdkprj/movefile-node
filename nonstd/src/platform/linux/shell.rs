...
pub fn open_file_property(_window_handle: isize, _file_path: &impl AsRef<Path>) -> Result<(), String> {
    Ok(())
}

pub fn open_path(_window_handle: isize, file_path: &impl AsRef<Path>) -> Result<(), String> {
...
pub fn open_path_with(_window_handle: isize, file_path: &impl AsRef<Path>) -> Result<(), String> {
...
pub fn show_item_in_folder(file_path: &impl AsRef<Path>) -> Result<(), String> {
...
pub fn trash(file: &impl AsRef<Path>) -> Result<(), String> {
