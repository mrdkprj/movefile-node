...
pub fn mv(source_file: String, dest_file: String, callback: Option<&dyn Fn(i64, i64)>, cancellable: Option<u32>) -> Result<(), String> {
    platform_impl::mv(source_file, dest_file, callback, cancellable)
}

pub fn mv_bulk(source_files: Vec<String>, dest_dir: String, callback: Option<&dyn Fn(i64, i64)>, cancellable: Option<u32>) -> Result<(), String> {
